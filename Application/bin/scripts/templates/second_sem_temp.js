export class SecondSemester {
    
    static Schedule = `
<h1 sh>SECOND SEMESTER | ADVISER: <span id="class_adviser_2"></span></h1>
<br>
<h1 ctr>SCHEDULE</h1>
<div class="semester_schedule" style="border: 3px solid #000; border-radius: 10px;">
    <div class="sched_body">
        ...
        <div class="sched_row" data-sched-s>
...
<div class="divTable" style="border: 3px solid #000; border-radius: 10px;">
    <div class="divTableBody" data-grade-s>
